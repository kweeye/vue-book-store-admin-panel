<template lang="html">
    <div class="container-fluid p-5">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="th-width-100">Category</th>
                                                <th class="th-width-100">Author</th>
                                                 <th class="th-width-100">Tag</th>
                                    ...
                                    <nav class="paging_simple_numbers">
                                        <ul class="pagination pagination-md">
                                            ...
                                            <li class="page-book" v-for="page in metaData.last_page" :key="page"
        ...
        <b-modal id="bv-modal-delete" ref="my-modal" title="Delete" hide-footer>
            ...
            <b-button class="mt-3 btn-danger" block @click="deletebook()">Delete</b-button>
        </b-modal>
        <b-modal id="bv-modal-search" ref="my-modal" hide-footer>
            ...
            <div class="d-block text-center">
                <input class="form-control" placeholder="Book Name" v-model="filter.name">
            </div>
        ...
        <router-link class="float" to="book-create">
...
<script lang="js">
    ...
    export default {
        ...
        methods: {
            ...
            editData(data) {
                this.$router.replace({ path: 'book-edit', query: { page: this.filter.page, reverse: this.filter.reverse, sort: this.filter.sort, name: this.filter.name, id: data.id } }).catch(()=>{})
            },
            deleteData(data){
                this.id = data.id
            },
