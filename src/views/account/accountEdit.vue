			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<h6><a href="javascript:void(0)" class="text-info" @click="back()"> <i class="fas fa-arrow-left"></i></a> Edit Account <small>(Fields in red are required)</small></h6>
					</div>
					<div class="card-body">
...
<script lang="js">
	...
	export default {
		...
		methods: {
			...mapActions({
				accountUpdateAction: 'accountUpdateAction',
			...
			async onSubmit() {
				...
				await this.accountUpdateAction({
					...option
				}).then(res => {
					this.back()
				}).catch(err => this.isLoading = true)
