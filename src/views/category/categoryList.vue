<template lang="html">
    <div class="container-fluid p-5">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <nav class="paging_simple_numbers">
                                        <ul class="pagination pagination-md">
                                            ...
                                            <li class="page-category" v-for="page in metaData.last_page" :key="page"
        ...
        <b-modal id="bv-modal-delete" ref="my-modal" title="Delete" hide-footer>
            ...
            <b-button class="mt-3 btn-danger" block @click="deletecategory()">Delete</b-button>
        </b-modal>
        <b-modal id="bv-modal-search" ref="my-modal" hide-footer>
            ...
            <div class="d-block text-center">
                <input class="form-control" placeholder="Category Name" v-model="filter.name">
            </div>
        ...
        <router-link class="float" to="category-create">
...
<script lang="js">
    ...
    export default {
        ...
        methods: {
            ...
            editData(data) {
                this.$router.replace({ path: 'category-edit', query: { page: this.filter.page, reverse: this.filter.reverse, sort: this.filter.sort, name: this.filter.name, id: data.id } }).catch(()=>{})
            },
            deleteData(data){
                this.id = data.id
            },
            async deletecategory() {
				...
				await this.categoryDeleteAction({
					...option
				}).then(res => {
					this.fetchData()
                    this.$refs['my-modal'].hide()
