			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<h6>New Tag <small>(Fields in red are required)</small></h6>
					</div>
					<div class="card-body">
	...
	export default {
		...
		methods: {
			...
			async onSubmit() {
				...
				await this.tagStoreAction({
					...option
				}).then(res => {
					this.$router.replace({ path: 'tag-list', query: { page: 1, reverse: 'desc', sort: 'created_at', name: ''} }).catch(()=>{})
					this.isLoading = false;
